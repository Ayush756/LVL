...
from normStd import min_max_scale
...
def CandidateData():
    ...
    variety=user_inputs['variety']
    amenity = user_inputs['amenity']
    cost= user_inputs['cost']
    return influenced_population_5x5, closest_point_population, distance_score, capacity,variety,footfalls,amenity,cost

CandidateData()
#EDIT HERE 
# Data part 1: Candidate location data
influenced_population_5x5, closest_point_population, distance_score, capacity, variety , footfalls , amenity,cost= CandidateData()
# cand = data['candidate']
distance = distance_score

population = influenced_population_5x5
amenities = amenity
footfalls = footfalls
varieties = variety
capacities = capacity
cost 
pop_grid = closest_point_population

attractiveness = cost*10 + varieties*20 + capacities*3 + amenities*5
...
#=== Attraciveness compilation
        ###attractiveness 
comp_attractiveness =comp_costs*10 + comp_varieties*20+ comp_capacities*3+comp_pop_grids*5
...
all_populations = [population] + comp_populations
